...
import { Users, School, ArrowLeft, Search, Plus } from "lucide-react";
...
export default async function AdminStudentsPage() {
  ...
  return (
    <AppShell user={user} pageTitle="Student Directory">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Total active registered learners ({students.length})
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader
          ...
          subtitle="Complete student rosters, cohort classes, and admission numbers"
        />
